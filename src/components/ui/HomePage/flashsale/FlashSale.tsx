...
import Image from 'next/image';
 ...
 const clothes =  [
    ...
    },
    {
      ...
      "rating": 4.2,
      "category": "Jackets",
      "description": "Slim-fit jeans crafted from stretch denim for a comfortable yet stylish look."
    },
    {
      "id": 3,
      ...
      "rating": 4.8,
      "category": "T-shirts",
      "description": "A flowy maxi dress featuring a vibrant floral print, perfect for summer outings."
    },
    {
      "id": 4,
      ...
      "rating": 4.7,
      "category": "Jackets",
      "description": "A classic denim jacket with button-up closure and front pockets, ideal for layering."
    },
    {
      "id": 5,
      ...
      "rating": 4.4,
      "category": "Shirt",
      "description": "Casual canvas sneakers with a lace-up design, perfect for everyday wear."
    },
    {
      "id": 6,
      ...
      "rating": 4.6,
      "category": "Shirt",
      "description": "A cute mini skirt featuring pleated detailing, great for creating a chic look."
    },
    {
      "id": 7,
      ...
      "rating": 4.3,
      "category": "jacket",
      "description": "A cozy cable knit sweater perfect for staying warm during chilly days."
    },
    {
      "id": 8,
      ...
      "rating": 4.5,
      "category": "kids",
      "description": "Classic chino shorts made from lightweight cotton, ideal for summer adventures."
    },
    {
      "id": 9,
      ...
      "rating": 4.7,
      "category": "Blazers",
      "description": "A timeless single-breasted blazer crafted from high-quality wool blend fabric."
    },
    {
      "id": 10,
      ...
      "rating": 4.6,
      "category": "kids",
      "description": "A genuine leather belt with a classic buckle closure, perfect for adding a finishing touch to your outfit."
    }
  ]
